...
import { fetchGoldPrice , fetchUsdJptRate } from "../lib/apiClient";
import { calculateGoldPriceInJpy } from "../lib/priceCalculator";
...
export default async function handler(req, res) {
    try {
        ...
        // 並行してAPIからデータを取得
        const [goldData, usdjpyData] = await Promise.all([
        ...
        // 円での最終価格を計算
        const finalPrice = calculateGoldPriceInJpy(goldData, usdjpyData);
